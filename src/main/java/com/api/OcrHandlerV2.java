...
import com.service.OcrServiceV2;
...
public class OcrHandlerV2 extends AbstractHandler {

    private final Logger log = LoggerFactory.getLogger(this.getClass());
    public String docType;

    public OcrHandlerV2(String docType) {
    ...
    public void handle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        OcrServiceV2 service = new OcrServiceV2();
        String res = service.process(reqTime, baseRequest, request, docType);
